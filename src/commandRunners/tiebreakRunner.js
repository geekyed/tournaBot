const execute = async () => {
  return { header: 'Tiebreakers', message: 'If two players end a swiss tournament with equal points their position is' + 'determined by three tiebreak conditions, if one cannot find a winner we use the next rule.\n' +
